...
class StatusPageOperator:
    ...
    def UpdateComponentStatus(
        self, componentId: str, opLevel: OpLevel, incidentDetails: Incident = {}
    ) -> StatusResult:
        ...
        if (
            ...
            logger.info(
                "Changing status from %s to %s", component.status, componentStatus
            )
    ...
    def _updateComponentStatus(self, componentId, newComponentStatus):
        ...
        logger.debug(
            "Setting component status to %s: %s", newComponentStatus, componentId
        )
    ...
    def _processIncidentOnStatusChange(
        self, componentId: str, newComponentStatus: str, incidentDetails: Incident
    ) -> IncidentResult:
        ...
        if newComponentStatus == "operational" and asscIncidentCount > 0:
            ...
            self._createIncident(componentId, newComponentStatus, incidentDetails)
    ...
    def _createIncident(
        self, componentId, newComponentStatus: str, incidentDetails: Incident
    ):
        logger.info(
